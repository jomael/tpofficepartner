...
// ************************************************************************ //
// Type Lib: C:\PROGRA~1\COMMON~1\MICROS~1\VBA\VBA6\VBE6EXT.OLB
// IID\LCID: {0002E157-0000-0000-C000-000000000046}\0
// Helpfile: C:\PROGRA~1\COMMON~1\MICROS~1\VBA\VBA6\vbob6.chm
...
const
  ...
  IID__Windows_: TGUID = '{F57B7ED0-D8AB-11D1-85DF-00C04F98F42C}';
  ...
  IID__CodeModule: TGUID = '{0002E16D-0000-0000-C000-000000000046}';
  CLASS_CodeModule: TGUID = '{0002E16F-0000-0000-C000-000000000046}';
  IID__CodePanes: TGUID = '{0002E171-0000-0000-C000-000000000046}';
  CLASS_CodePanes: TGUID = '{0002E173-0000-0000-C000-000000000046}';
  IID__CodePane: TGUID = '{0002E175-0000-0000-C000-000000000046}';
  CLASS_CodePane: TGUID = '{0002E177-0000-0000-C000-000000000046}';
  IID__References: TGUID = '{0002E179-0000-0000-C000-000000000046}';
  IID_Reference: TGUID = '{0002E17D-0000-0000-C000-000000000046}';
  DIID__dispReferences_Events: TGUID = '{0002E19A-0000-0000-C000-000000000046}';
  CLASS_References: TGUID = '{0002E17B-0000-0000-C000-000000000046}';
...
// *********************************************************************//
  _Windows_ = interface(_Windows_old)
    ...
    function CreateToolWindow(const AddInInst: AddIn; const ProgId: WideString; 
                              ...
                              var DocObj: IDispatch): Window_; safecall;
  end;
...
// *********************************************************************//
  _Windows_Disp = dispinterface
    ...
    function CreateToolWindow(const AddInInst: AddIn; const ProgId: WideString; 
                              const Caption: WideString; const GuidPosition: WideString; 
                              var DocObj: IDispatch): Window_; dispid 300;
    property VBE: VBE readonly dispid 1;
    property Parent: Application_ readonly dispid 2;
    function Item(index: OleVariant): Window_; dispid 0;
    property Count: Integer readonly dispid 201;
...
// GUID:      {0002E16D-0000-0000-C000-000000000046}
// *********************************************************************//
  _CodeModule = interface(IDispatch)
    ['{0002E16D-0000-0000-C000-000000000046}']
...
// GUID:      {0002E171-0000-0000-C000-000000000046}
// *********************************************************************//
  _CodePanes = interface(IDispatch)
    ['{0002E171-0000-0000-C000-000000000046}']
    function Get_Parent: VBE; safecall;
    function Get_VBE: VBE; safecall;
...
// Interface: _CodePane
// Flags:     (4544) Dual NonExtensible OleAutomation Dispatchable
// GUID:      {0002E175-0000-0000-C000-000000000046}
// *********************************************************************//
  _CodePane = interface(IDispatch)
    ['{0002E175-0000-0000-C000-000000000046}']
...
// Flags:     (4560) Hidden Dual NonExtensible OleAutomation Dispatchable
// GUID:      {0002E179-0000-0000-C000-000000000046}
// *********************************************************************//
  _References = interface(IDispatch)
    ['{0002E179-0000-0000-C000-000000000046}']
    function Get_Parent: VBProject; safecall;
    function Get_VBE: VBE; safecall;
...
// Interface: Reference
// Flags:     (4544) Dual NonExtensible OleAutomation Dispatchable
// GUID:      {0002E17D-0000-0000-C000-000000000046}
// *********************************************************************//
  Reference = interface(IDispatch)
    ['{0002E17D-0000-0000-C000-000000000046}']
...
// GUID:      {0002E19A-0000-0000-C000-000000000046}
// *********************************************************************//
  _dispReferences_Events = dispinterface
    ['{0002E19A-0000-0000-C000-000000000046}']
