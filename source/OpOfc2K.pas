...
// ************************************************************************ //
// Type Lib: C:\Program Files\Microsoft Office\Office\mso9.dll
...
// MsoButtonStyleHidden constants
type
...
// MsoCommandBarButtonHyperlinkType constants
type
...
// MsoFarEastLineBreakLanguageID constants
type
...
const
  ...
  msoLanguageIDBosniaHerzegovina = $0000101A;
...
// *********************************************************************//
  DocumentProperty = interface(IDispatch)
    ...
    function Get_Application_(out ppidisp: IDispatch): HResult; stdcall;
