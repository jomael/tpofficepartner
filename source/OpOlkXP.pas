...
// PASTLWTR : $Revision$
// File generated on 1/16/2002 3:50:29 PM from Type Library described below.
...
uses Windows, ActiveX, Classes, Graphics, OleCtrls, StdVCL, OpOfcXP, OpShared;
...
// *********************************************************************//
  _IPageWrapCtrl = interface(IDispatch)
    ...
    function  Get_BackColor(out pcolorRef: DWord): HResult; stdcall;
    function  Set_BackColor(pcolorRef: DWord): HResult; stdcall;
  end;
...
// *********************************************************************//
  _DPageWrapCtrl = dispinterface
    ...
    property BackColor: DWord dispid 64090;
  end;
